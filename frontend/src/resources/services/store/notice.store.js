...
export const useNoticeStore = defineStore('Notices', {
  state: () => ({
    group: [
      { name: "🛍 Emprendimientos", value: 1 },
      { name: "🛠️ Servicios", value: 2 },
      { name: "🛒 Compra, venta y alquiler", value: 3 },
      { name: "💼 Oportunidades", value: 4 },
      { name: "🤝 Comunidad", value: 5 },
    ],
    category: [
      [],
      [
        ...
        { name: "💄 Belleza y bienestar", value: 2 },
        { name: "🏠 Hogar y decoración", value: 3 },
        { name: "🎁 Regalos y personalizados", value: 4 },
        { name: "🧵 Artesanías y manualidades", value: 5 },
        { name: "📦 Otros emprendimientos", value: 6 },
      ],
      [
        { name: "👨‍🔧 Reparaciones y mantenimiento", value: 0 },
        { name: "🧹 Limpieza", value: 1 },
        { name: "👩‍🏫 Clases y tutorías", value: 2 },
        { name: "💻 Tecnología", value: 4 },
        { name: "🐶 Mascotas", value: 3 },
        { name: "🚗 Transporte", value: 5 },
        { name: "📋 Otros servicios", value: 6 },
      ],
      [
        { name: "🛍️ Venta de artículos", value: 0 },
        { name: "🔎 Busco comprar", value: 1 },
        { name: "🏷️ Alquiler", value: 2 },
        { name: "🚗 Vehículos y accesorios", value: 3 },
        { name: "🏠 Inmuebles", value: 4 },
      ],
      [
        { name: "👔 Empleo", value: 0 },
        { name: "🎉 Eventos", value: 1 },
        { name: "🎁 Promociones y descuentos", value: 2 },
        { name: "📢 Otros", value: 3 },
      ],
      [
        { name: "Objetos perdidos", value: 0 },
        { name: "Donaciones", value: 1 },
        { name: "Intercambios", value: 2 },
        { name: "Recomendaciones ", value: 3 },
      ]
    ]
  }),
  actions: {
