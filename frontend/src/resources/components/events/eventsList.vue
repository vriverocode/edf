...
const goToDetail = (eventId) => {
  const isAdminView = [1, 6, 8].includes(user.value?.rol_id)
  goTo((isAdminView ? '/admin/events/view/' : '/client/events/view/') + eventId)
}
...
<template>
    ...
    >
      ...
      <div class="md:px-6 md:pt-4 pb-2 px-3 pt-2 border-gray-300">
        ...
        <div class="flex justify-between items-center mb-1">
          <div class="ellipsis" style="width: 90%" @click="goToDetail(event.id)">
                ...
                <q-list style="min-width: 150px">
                  ...
                  <template v-if="user.rol_id == 1">
                    <q-item
                      clickable
                      v-close-popup
                      @click="goTo('/admin/events/form/update/' + event.id)"
                    >
        ...
        <div class="flex items-center space-x-4" >
          ...
          <div class="flex-1 space-y-2" @click="goToDetail(event.id)">
            ...
            <div class="flex items-center text-sm text-gray-700">
              ...
              <span class="font-medium"> {{ event.time_from }} - {{ event.time_to }} </span>
            </div>
            <div class="flex items-center text-sm text-gray-700">
  ...
  <div v-else class="flex flex-col items-center justify-center py-20">
    ...
    <p class="text-gray-600 text-center mb-6">
      Aquí encontrarás los próximos eventos y actividades organizados para los residentes del
      edificio.
    </p>
  </div>
</template>
