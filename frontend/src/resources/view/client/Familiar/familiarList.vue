                ...
                <div v-for="user in users" :key="user.id"
                    ...
                    <div class="flex items-center pb-3 pl-2 md:pl-5 ">
                        ...
                        <div class="ml-2">
                            ...
                            <div class="flex items-center">
                                <div class="text-body2 text-grey-6 ">#{{ user.apartaments.length > 0 ?
                                    user.apartaments[0].number :
                                    'Apt. no asignado' }}</div>
                    ...
                    <div class="flex justify-end  items-center pb-3 pt-1 pr-2 md:pr-5 ">
                        <div v-if="user.apartaments.length == 0">
                            <q-btn :icon="materialIcons.outlinedAddHomeWork" class="mx-1" flat color="yellow-9" round
                                size="0.9rem" @click="goTo('/admin/users/assing-apartment/' + user.id)">
                    ...
                    <div class="flex justify-end px-2 w-full pt-3 " style="border-top: 1px solid lightgrey;">
                        ...
                        <div>
                            <q-btn :icon="materialIcons.outlinedEvent" class="mx-1" color="light-green-9" flat
                                size="0.9rem">
                                <q-tooltip transition-show="flip-right" transition-hide="flip-left"
                                    class="bg-black text-body2 px-2">
                                    Ver reservas
