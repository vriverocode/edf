            ...
            <Transition name="horizontal">
                <div class="row w-full" v-if="step == 0">
                    <div class="col-md-6 md:my-0 col-12 my-1 px-2 md:px-12">
                        ...
                        <q-input borderless clearable v-model="formData.name" class="form__inputsCR mt-2"
                    ...
                    <div class="col-md-6 md:my-0 col-12 my-1 px-2 md:px-12">
                        ...
                        <q-input borderless clearable v-model="formData.username" class="form__inputsCR mt-2"
                            color="primary"
                    ...
                    <div class="col-md-6 md:my-0 col-12 my-1 px-2 md:px-12">
                        ...
                        <q-input borderless clearable v-model="formData.email" class="form__inputsCR mt-2"
                            color="primary"
                    ...
                    <div class="col-md-6 md:my-0 col-12 my-1 px-2 md:px-12">
                        ...
                        <q-input borderless clearable v-model="formData.password" class="form__inputsCR mt-2"
                    ...
                    <div class="col-md-6 md:my-0 col-12 my-1 px-2 md:px-12">
                        ...
                        <phoneNumberInput v-model="formData.phone" label="Tu Teléfono" placeholder="412-1234567"
                ...
                <div class="row w-full" v-if="step == 1">
                    <div class="col-md-6 md:my-0 col-12 my-1 mb-4 px-2 md:px-12">
                        ...
                        <q-select borderless class="form__inputsCR mt-2" v-model="formData.rol_id" option-value="id"
                            option-label="title" :options="rolOptions" behavior="menu">
                        </q-select>
                    </div>
                    <div class="col-md-6 md:my-0 col-12 my-1 px-2 md:px-12">
                        <div class="text-subtitle2 text-bold text-black">
                        ...
                        <q-select borderless class="form__inputsCR mt-2" v-model="formData.apartment" option-value="id"
                            option-label="number" :options="apartmentsOptions" behavior="menu">
