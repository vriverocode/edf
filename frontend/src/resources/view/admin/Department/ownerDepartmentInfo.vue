  ...
  <div class="md:px-32 px-2 pb-12 h-full" style="overflow: auto; ">
    <q-card flat bordered class="q-mb-md">
      <q-card-section>
        ...
        <div class="text-subtitle2 q-mt-xs" v-if="apartment" style="text-transform: uppercase;">
      ...
      <q-card-section v-if="!loading">
        <div class="row q-col-gutter-md">
          ...
          <div class="col-12 col-md-6" v-if="owner">
            ...
            <div class="text-subtitle1 text-weight-medium">{{ moment(owner.created_at).from(moment()) || '-----' }}
            </div>
          </div>
          <div class="col-12 col-md-6" v-if="owner">
