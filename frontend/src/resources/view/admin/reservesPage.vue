            ...
            <div class="px-0 pb-4 pt-2 border-b border-dashed border-gray-300 cursor-pointer" @click="goToDetail(reserve.id)">
              ...
              <div class="flex row items-end">
                <div class="flex-1 col-12 px-4 row">
                  <div class="flex justify-start items-center col-md-3 col-5 text-sm text-gray-700" style="margin-top: 3px;">
                  ...
                  <div class="flex justify-start items-center col-md-3 col-5 text-sm text-gray-700 pt-2 md:pt-0" style="margin-top: 3px;">
                  ...
                  <div class="flex justify-start items-center col-md-3 col-5 text-sm text-gray-700 pt-2" style="margin-top: 3px;">
                    <svg class="w-4 h-4 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  ...
                  <div class="flex justify-start items-center col-md-3 col-5 text-sm text-gray-700 pt-2" style="margin-top: 3px;">
                    ...
                    <q-icon v-if="paymentStatusIcon(reserve)" :name="paymentStatusIcon(reserve)"
                      :color="paymentStatusColor(reserve)" size="xs" class="q-ml-xs" style="transform:translateY(-1px)">
