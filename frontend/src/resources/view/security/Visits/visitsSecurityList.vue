...
const getVisits = () => {
  ready.value = false
  visitStore.getVisitsForSecurity()
    .then((response) => {
        ...
        <template v-if="visits.length > 0">
          <div class="mt-4 md:mt-8" style="height: 92%; overflow: scroll">
            <div class="px-4 md:mx-24 md:pr-12">
              <div v-for="visit in visits" :key="visit.id" class="my-3 listVisit-container"
                ...
                <div class="md:py-4 pt-1 visitListContainer flex items-center justify-between">
                  <div class="flex items-center pb-2 pl-2 md:pl-5">
                    ...
                    <div class="ml-2">
                      ...
                      <div class="">
                        ...
                        <div class="text-body2 text-grey-6" v-if="visit.airbnb_rent_id" style="text-decoration:underline">
                  ...
                  <div class="flex justify-between items-center py-2 pr-2 md:pr-5 w-full" style="border-top: 1px solid #e0e0e0;">
                    ...
                    <div class="flex items-center">
                      <q-btn color="primary" unelevated size="0.85rem" style="border-radius: 0.5rem;"
                        no-caps 
                        :loading="loadingId === visit.id" :disable="loadingId !== null"
                        @click="confirmArrived(visit)">
                        Marcar llegado
                      </q-btn>
                    </div>
                  </div>
